...
func (m *MockControllerService) SearchUserProfileSnippets(query, lastUsername string, limit int) ([]*model.UserProfileSnippet, string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockControllerServiceMockRecorder) SearchUserProfileSnippets(query, lastUsername, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchUserProfileSnippets", reflect.TypeOf((*MockControllerService)(nil).SearchUserProfileSnippets), query, lastUsername, limit)
}
