...
//
//	mockgen -source=object_storage.go -destination=mock/object_storage.go
//
...
func (mr *MockObjectStorageClientMockRecorder) DeleteObjects(objectKeys any) *gomock.Call {
...
func (mr *MockObjectStorageClientMockRecorder) GetPreSignedUrlForGettingObject(objectKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockObjectStorageClientMockRecorder) GetPreSignedUrlForPuttingObject(objectKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
